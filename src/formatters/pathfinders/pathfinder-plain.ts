...
export function renderPlain(currentNodeName : string, apexMethod : ApexMethod | null, apexSection: ApexSection,
    fn: (target: null|string, apexMethod: ApexMethod | null) => ApexSection|undefined) : ApexSection | undefined {
